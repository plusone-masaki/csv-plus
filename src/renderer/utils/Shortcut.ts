...
shortcut.addKeybinding('fill_up', { key: 'ArrowUp', ctrlKey: process.platform !== 'darwin', metaKey: process.platform === 'darwin', shiftKey: true })
shortcut.addKeybinding('fill_down', { key: 'ArrowDown', ctrlKey: process.platform !== 'darwin', metaKey: process.platform === 'darwin', shiftKey: true })
shortcut.addKeybinding('fill_left', { key: 'ArrowLeft', ctrlKey: process.platform !== 'darwin', metaKey: process.platform === 'darwin', shiftKey: true })
shortcut.addKeybinding('fill_right', { key: 'ArrowRight', ctrlKey: process.platform !== 'darwin', metaKey: process.platform === 'darwin', shiftKey: true })
